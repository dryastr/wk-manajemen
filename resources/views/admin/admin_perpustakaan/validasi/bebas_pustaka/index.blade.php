...
@section('title', 'Menu Validasi Bebas Pustaka')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Validasi Bebas Pustaka Siswa</h4>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="belum-divalidasi" role="tabpanel"
                                ...
                                <div class="flex">
                                    <a href="{{ route('bebas_pustaka.export', 'tidak') }}"
                                        class="btn btn-success mb-4">Export Excel Belum Divalidasi</a>
                                </div>
                                @include(
                                    'admin.admin.validasi.bebas_pustaka.partials.bebas_pustaka_table',
                                    [
                            ...
                            <div class="tab-pane fade" id="sudah-divalidasi" role="tabpanel"
                                ...
                                <div class="flex">
                                    <a href="{{ route('bebas_pustaka.export', 'iya') }}"
