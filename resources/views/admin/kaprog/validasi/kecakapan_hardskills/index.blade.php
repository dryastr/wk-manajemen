...
@section('title', 'Menu Validasi Kecakapan Hardskill')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Validasi Kecakapan Hardskill Siswa</h4>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="belum-divalidasi" role="tabpanel"
                                ...
                                <div class="flex">
                                    <a href="{{ route('validasi_kecakapan.export', 'tidak') }}"
                                        class="btn btn-success mb-4">Export Excel Belum Divalidasi</a>
                                </div>
                                @include(
                                    'admin.kaprog.validasi.kecakapan_hardskills.partials.kecakapan_hardskill_table',
                                    [
                            ...
                            <div class="tab-pane fade" id="sudah-divalidasi" role="tabpanel"
                                ...
                                <div class="flex">
                                    <a href="{{ route('validasi_kecakapan.export', 'iya') }}"
