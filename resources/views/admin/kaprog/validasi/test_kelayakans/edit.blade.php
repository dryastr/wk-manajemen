    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Validasi untuk {{ $user->name }}</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('validasi.update', $user->id) }}" method="POST" class="form form-horizontal">
                        @csrf
                        @method('PUT')
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group">
                                    <select id="test_kelayakan" name="test_kelayakan"
                                        ...
                                        <option value="iya" {{ $user->test_kelayakan === 'iya' ? 'selected' : '' }}>Iya
                                        </option>
                                        <option value="tidak" {{ $user->test_kelayakan === 'tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
